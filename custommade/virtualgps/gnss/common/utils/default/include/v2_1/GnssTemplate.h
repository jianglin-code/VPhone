...
std::unique_ptr<V2_0::GnssLocation> GnssTemplate<T_IGnss>::getLocationFromHW() {
    double latitudeDegrees = gMockLatitudeDegrees;
    double longitudeDegrees = gMockLongitudeDegrees;
    double altitudeMeters = gMockAltitudeMeters;
    ...
    latitudeDegrees = std::stof(android::base::GetProperty("persist.ro.custommade.lo.latitude", "1.30")) + static_cast<int64_t>(std::rand() % 10) * 0.000001;
    latitudeDegrees = static_cast<int64_t>(latitudeDegrees * 1e6) / 1e6;
    longitudeDegrees = std::stof(android::base::GetProperty("persist.ro.custommade.lo.longitude", "103.82")) + static_cast<int64_t>(std::rand() % 10) * 0.000001;
    longitudeDegrees = static_cast<int64_t>(longitudeDegrees * 1e6) / 1e6;
    altitudeMeters = std::stof(android::base::GetProperty("persist.ro.custommade.lo.altitude", "0.0"));
    altitudeMeters = static_cast<int64_t>(altitudeMeters * 1e6) / 1e6;
    speedMetersPerSec = std::stof(android::base::GetProperty("persist.ro.custommade.lo.speedmeters", "0.2")) + static_cast<int64_t>(std::rand() % 10) * 0.1;
    bearingDegrees = std::stof(android::base::GetProperty("persist.ro.custommade.lo.bearing", "80.0")) + static_cast<int64_t>(std::rand() % 36) * 1.0;
    horizontalAccuracyMeters = std::stof(android::base::GetProperty("persist.ro.custommade.lo.horizontalaccuracy", "35.0"));
    verticalAccuracyMeters = std::stof(android::base::GetProperty("persist.ro.custommade.lo.verticalaccuracy", "35.0"));
    speedAccuracyMetersPerSecond = std::stof(android::base::GetProperty("persist.ro.custommade.lo.speedaccuracy", "0.1"));
    bearingAccuracyDegrees = std::stof(android::base::GetProperty("persist.ro.custommade.lo.bearingaccuracy", "1.0"));
    //timestamp = std::stol(android::base::GetProperty("persist.ro.custommade.lo.timestamp", "1519930775453"));

    //ALOGW("latitudeDegrees: %.12f longitudeDegrees: %.12f  altitudeMeters: %.12f", latitudeDegrees, longitudeDegrees, altitudeMeters);
    ...
    V1_0::GnssLocation locationV1 = {
            .gnssLocationFlags = V1_0::GnssLocationFlags::HAS_LAT_LONG | 
...
Return<bool> GnssTemplate<T_IGnss>::setCallback(const sp<V1_0::IGnssCallback>& callback) {
    ...
    V2_1::IGnssCallback::GnssSystemInfo gnssInfo = {.yearOfHw = 2025};
...
Return<bool> GnssTemplate<T_IGnss>::setCallback_2_0(const sp<V2_0::IGnssCallback>& callback) {
    ...
    V1_1::IGnssCallback::GnssSystemInfo gnssInfo = {.yearOfHw = 2025};
