...
public:
    ...
    virtual status_t createSession(int id) = 0;
    virtual status_t destroySession(int id) = 0;
    virtual status_t setSurface(int id, const sp<IGraphicBufferProducer>& bufferProducer, int32_t width, int32_t height, int32_t format, int32_t transform) = 0;
    virtual status_t releaseSurface(int id) = 0;
    virtual status_t setCallBackSurface(int id, const sp<IGraphicBufferProducer>& bufferProducer, int32_t width, int32_t height, int32_t format, int32_t transform) = 0;
    virtual status_t releaseCallBackSurface(int id) = 0;
};
