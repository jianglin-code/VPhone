...
status_t BnVirtualCameraService::onTransact(uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code)
    {
        case CREATESESSION:
        {
            ...
            status_t result = createSession(id);
        ...
        case DESTROYSESSION:
        {
            ...
            status_t result = destroySession(id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        break;
        case SETSURFACE:
        {
            ...
            status_t result = setSurface(id, st, width, height, format, transform);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        break;
        case RELEASESURFACE:
        {
            ...
            status_t result = releaseSurface(id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        break;
        case SETCALLBACKSURFACE:
        {
            ...
            status_t result = setCallBackSurface(id, st, width, height, format, transform);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        break;
        case RELEASECALLBACKSURFACE:
        {
            ...
            status_t result = releaseCallBackSurface(id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        break;
