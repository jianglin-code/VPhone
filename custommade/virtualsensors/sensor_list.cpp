...
constexpr char kAospVendor[] = "QTI";
...
const SensorInfo kAllSensors[] = {
    ...
    },
    {
        ...
        .name = "3-axis Magnetic field sensor (uncalibrated)",
        .vendor = kAospVendor,
        .version = 1,
    ...
    },
    {
        ...
        .name = "3-axis Gyroscope (uncalibrated)",
        .vendor = kAospVendor,
        .version = 1,
